...
export default function About() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-blue-900 py-16">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-white mb-8 leading-tight pb-2 md:text-4xl text-center mx-0">
            From Plumber to 
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400 text-3xl">
